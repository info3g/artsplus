    ...
    <div class="dokan-dashboard-content dokan-product-edit">
        ...
        <header class="dokan-dashboard-header dokan-clearfix">
            <h1 class="entry-title">
                <?php if ( !$post_id ): ?>
                    <?php _e( 'Add New Art', 'dokan' ); ?>
                <?php else: ?>
                    <?php _e( 'Edit Art', 'dokan' ); ?>
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="view-product dokan-btn dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Art', 'dokan' ); ?></a>
                        </span>
                    <?php } ?>
        ...
        <div class="product-edit-new-container">
            ...
            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                <div class="dokan-message">
                    ...
                    <strong><?php _e( 'Success!', 'dokan' ); ?></strong> <?php _e( 'The art has been saved successfully.', 'dokan' ); ?>

                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php _e( 'View Art &rarr;', 'dokan' ); ?></a>
                    <?php } ?>
                </div>
            <?php } ?>
                ...
                if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                    ...
                    <form class="dokan-product-edit-form" role="form" method="post">
                            ...
                            <div class="content-half-part">
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        ...
                                        <label for="product_cat" class="form-label"><?php _e( 'Medium', 'dokan' ); ?></label>
                                        ...
                                        $category_args =  array(
                                            'show_option_none' => __( '- Select a medium -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat',
                                            'id'               => 'product_cat',
									...
									<div class="dokan-form-group">
                                        ...
                                        <label for="product_cat" class="form-label"><?php _e( 'Size', 'dokan' ); ?></label>
                                        <div class="dokan-product-cat-alert dokan-hide dokan-alert dokan-alert-danger">
                                            <?php _e('Please choose a size !!!', 'dokan'); ?>
                                        </div>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                        ...
                                        $category_args =  array(
                                            'show_option_none' => __( '- Select a Size -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat1',
                                            'id'               => 'product_cat',
									...
									<div class="dokan-form-group">
                                        ...
                                        <label for="product_cat" class="form-label"><?php _e( 'Style', 'dokan' ); ?></label>
                                        <div class="dokan-product-cat-alert dokan-hide dokan-alert dokan-alert-danger">
                                            <?php _e('Please choose a style !!!', 'dokan'); ?>
                                        </div>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                        ...
                                        $category_args =  array(
                                            'show_option_none' => __( '- Select a Style -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat2',
                                            'id'               => 'product_cat',
									...
									<div class="dokan-form-group">
                                        ...
                                        <label for="product_cat" class="form-label"><?php _e( 'Subject', 'dokan' ); ?></label>
                                        <div class="dokan-product-cat-alert dokan-hide dokan-alert dokan-alert-danger">
                                            <?php _e('Please choose a subject !!!', 'dokan'); ?>
                                        </div>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                ...
                                <div class="dokan-form-group">
                                    ...
                                    echo str_replace( '<select', '<select data-placeholder="'.__( 'Select art tags','dokan' ).'" multiple="multiple" ', $drop_down_tags );
                            ...
                            <div class="content-half-part featured-image">
                                ...
                                <div class="dokan-feat-image-upload">
                                    ...
                                    <div class="instruction-inside<?php echo $instruction_class; ?>">
                                        ...
                                        <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php _e( 'Upload a art cover image', 'dokan' ); ?></a>
                                    </div>
                        ...
                        <div class="dokan-product-short-description">
                            <label for="post_excerpt" class="form-label"><?php _e( 'Provide Comments About This Piece of Art', 'dokan' ); ?></label>
                        ...
                        <div class="dokan-product-inventory dokan-edit-row dokan-clearfix">
                            <div class="dokan-side-left">
                                ...
                                <p>
                                    <?php _e( 'Manage inventory, and configure the options for selling this art.', 'dokan' ); ?>
                                </p>
                            </div>
                            ...
                            <div class="dokan-side-right">
                                ...
                                <div class="dokan-form-group hide_if_variation">
                                    <?php dokan_post_input_box( $post_id, '_manage_stock', array( 'label' => __( 'Enable art stock management', 'dokan' ) ), 'checkbox' ); ?>
                                </div>
                                ...
                                <div class="dokan-form-group">
                                    <?php dokan_post_input_box( $post_id, '_sold_individually', array('label' => __( 'Allow only one quantity of this art to be bought in a single order', 'dokan' ) ), 'checkbox' ); ?>
                                </div>
                        ...
                        <div class="dokan-other-options dokan-edit-row dokan-clearfix">
                            ...
                            <div class="dokan-side-right">
                                <?php if ( $post_id ): ?>
                                    <div class="dokan-form-group">
                                        <label for="post_status" class="form-label"><?php _e( 'Art Status', 'dokan' ); ?></label>
                                ...
                                <div class="dokan-form-group">
                                    ...
                                    <?php dokan_post_input_box( $post_id, '_enable_reviews', array('value' => $_enable_reviews, 'label' => __( 'Enable Art reviews', 'dokan' ) ), 'checkbox' ); ?>
                                </div>
                        ...
                        <input type="hidden" name="dokan_add_product" value="<?php esc_attr_e( 'Save Art', 'dokan' ); ?>"/>
                        <input type="submit" name="dokan_add_product" class="dokan-btn dokan-btn-theme dokan-btn-lg btn-block" value="<?php esc_attr_e( 'Save Art', 'dokan' ); ?>"/>
