...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.firstVisitPopup.min.js" type="text/javascript" defer></script>
    <script>
	 jQuery(document).ready(function(){ 
		...
		jQuery(".woocommerce-MyAccount-navigation ul li:nth-child(4n)").add('ul li:last').after('<li class="woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--fav_list"><a href="http://artsplus.com/my-account/wishlist/">Favorites</a></li>');
		jQuery(".woocommerce-MyAccount-navigation ul li:nth-child(5n)").add('ul li:last').after('<li class="woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--follow"><a href="http://artsplus.com/my-account/following-artists/">Following Artists</a></li>');
				...
				jQuery.ajax({
					...
					success: function(data)  
					{
						...
						if( jQuery.trim(data) === "success" )
						{
							...
							alert('One(1) Art uploaded successfully.');
							location.reload();
						}
			...
			if(isValid){
				jQuery.ajax({
					...
					success: function(data)  
					{
						...
						if( jQuery.trim(data) === "success" )
						{
							alert('Two(2) Arts uploaded successfully.');
							location.reload();
						}
						else if(jQuery.trim(data)=== 'Invalid'){
							jQuery('.errormsg').append("<li>Invalid file Size or Type.</li>");
			...
			if(isValid){
				jQuery.ajax({
					...
					success: function(data)  
					{
						...
						if( jQuery.trim(data) === "success" )
						{
							alert('Three(3) Arts uploaded successfully.');
							location.reload();
						}
						else if(jQuery.trim(data)=== 'Invalid'){
							jQuery('.errormsg').append("<li>Invalid file Size or Type.</li>");
